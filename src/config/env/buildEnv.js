...
export const env = {
  ...
  SERVICEABILITY_COOKIE_SAMESITE: parsed.data.SERVICEABILITY_COOKIE_SAMESITE ?? "lax",
  SERVICEABILITY_COOKIE_SECURE:
    parsed.data.SERVICEABILITY_COOKIE_SECURE ?? parsed.data.NODE_ENV === "production",
  SERVICEABILITY_COOKIE_DOMAIN: parsed.data.SERVICEABILITY_COOKIE_DOMAIN?.trim() || "",
  ...
  CACHE_ON: parsed.data.CACHE_ON ?? true,
  ...
  OUTBOX_WORKER_ENABLED: parsed.data.OUTBOX_WORKER_ENABLED ?? true,
  ...
  STOREFRONT_CATALOG_REALTIME_TOKEN: parsed.data.STOREFRONT_CATALOG_REALTIME_TOKEN?.trim() || "",
