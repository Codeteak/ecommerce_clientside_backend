...
export const envSchema = z
  .object({
    ...
    DISABLE_CUSTOMER_AUTH: z.preprocess(boolFromEnv, z.boolean()).default(false),
    DEV_AUTH_USER_ID: z.string().uuid().default("00000000-0000-4000-8000-000000000001"),
    DEV_AUTH_CUSTOMER_ID: z.string().uuid().default("00000000-0000-4000-8000-000000000001"),
    ...
    STOREFRONT_PRODUCT_LIST_CACHE_MAX_LIMIT: z.coerce.number().int().min(1).max(100).default(50),
    STOREFRONT_PRODUCT_LIST_CACHE_MAX_OFFSET: z.coerce.number().int().min(0).max(10_000).default(100),
    STOREFRONT_PRODUCT_SEARCH_CACHE_MIN_CHARS: z.coerce.number().int().min(1).max(32).default(3),
    STOREFRONT_PROMO_CACHE_TTL_SEC: z.coerce.number().int().min(0).max(86_400).default(0),
    SHOP_RESOLVE_CACHE_TTL_SEC: z.coerce.number().int().min(0).max(86_400).default(300),
    SHOP_SERVICE_AREA_CACHE_TTL_SEC: z.coerce.number().int().min(0).max(86_400).default(180),
